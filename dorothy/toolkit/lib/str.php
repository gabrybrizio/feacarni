...
class Str {
  ...
  public static function html_cut($text, $length = 100, $ending = '...', $exact = true, $considerHtml = false) {
    if (is_array($ending)) {
            extract($ending);
    }
    if ($considerHtml) {
  ...
  // Trasforma una stringa 1.000,50 in decimal 1000.50
  public static function toDecimal($string){
    // Elimino eventuali punti
