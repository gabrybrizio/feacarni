...
class Database {
  ...
  protected function hit($query, $bindings = array()) {
    ...
    // reset some stuff
    // commentato per poter usare ->fail(false) per le transazioni in modo da far
    // il rollback in caso di eccezioni
    //$this->fail = false;
  ...
  /**
   * Begin transaction.
   * Set ->fail(true) for throw eventuals exceptions
   *
   * @return void
   */
  public function beginTransaction() {
    // in una transazione gli errori devono sempre esser lanciati
    // per poter effettuare un eventuale rollback
    $this->fail();
